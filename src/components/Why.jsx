      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center mb-6 bg-white/70 px-5 py-3 rounded-full backdrop-blur-sm border border-slate-200 shadow-sm">
            ...
            <span className={`${typography.small} text-slate-700`}>TRUSTED WORLDWIDE</span>
          </div>
        ...
        >
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="text-center md:text-left">
              <h3 className={`${typography.h3} text-slate-800 mb-3`}>Our Traveler's Guarantee</h3>
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-3">
                <div className="flex items-center bg-white px-4 py-2 rounded-full border border-slate-200 shadow-sm">
                  <span className={`${typography.small} text-slate-700`}>✓ No hidden fees</span>
                </div>
                <div className="flex items-center bg-white px-4 py-2 rounded-full border border-slate-200 shadow-sm">
                  <span className={`${typography.small} text-slate-700`}>✓ Flexible cancellation</span>
                </div>
                <div className="flex items-center bg-white px-4 py-2 rounded-full border border-slate-200 shadow-sm">
                  <span className={`${typography.small} text-slate-700`}>✓ 24/7 support</span>
                </div>
              </div>
            </div>
          </div>
